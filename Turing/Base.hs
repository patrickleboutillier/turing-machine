module Turing.Base (Symbol, Domain, blankSym, Operation(L, R, P, E)) where


-- A symbol is what can be printed on the tape of a Turing machine. We use a string because 
-- sometime a symbol can use more than one character.
type Symbol = String
...
-- Display the tape as a series of squares, with current square surrounded by square brackets.
